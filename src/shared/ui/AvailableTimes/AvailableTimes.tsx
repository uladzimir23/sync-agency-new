...
import { BookingDate } from '@/shared/hooks/useCalendar'
...
export const AvailableTimes: React.FC<AvailableTimesProps> = ({
  ...
  return (
    <div className={`available-times ${scrollable ? 'available-times--scrollable' : ''}`}>
      <h4 className="available-times__title">
        Available times for {formatDate(selectedDateObj.date)}
      </h4>
      <div className="available-times__container">
        <ButtonStack 
          direction="row" 
          spacing={6}
