        ...
        {selectedTimeObj ? (
          <div className="appointment-details__content">
            ...
            <div className="appointment-details__item">
              ...
              <span className="appointment-details__value">Free 30-minute consultation</span>
            </div>
            <div className="appointment-details__item">
            ...
            <p className="appointment-details__note">
              After confirmation, our manager will contact you <br/> to clarify details and send the meeting link.
            </p>
          </div>
        ) : (
          <div className="appointment-details__placeholder">
            <div className="appointment-details__placeholder-icon">📅</div>
    ...
    <div className="appointment-details appointment-details--confirmed">
      ...
      <div className="appointment-details__success-details">
        ...
        <div className="appointment-details__success-item">
          ...
          <span className="appointment-details__success-value">Free Consultation</span>
        </div>
      </div>
